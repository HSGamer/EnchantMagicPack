...
public class ToolsUtils {
    ...
    public static List<XMaterial> AXES_BLOCKS = new ArrayList<>(Arrays.asList(
            ...
            XMaterial.LEGACY_DAYLIGHT_DETECTOR_INVERTED,
            XMaterial.LEGACY_FENCE,
            XMaterial.LEGACY_FENCE_GATE,
            XMaterial.LEGACY_HUGE_MUSHROOM_1,
            XMaterial.LEGACY_HUGE_MUSHROOM_2,
            XMaterial.JUKEBOX,
            XMaterial.LADDER,
